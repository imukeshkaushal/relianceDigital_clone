  ...
  return (
    <>
     <Box as="header"  bg='#e42529' w='100%' h='30px'   color='white'>
      ...
      <Box bg={useColorModeValue('#e42529', '#e42529')} className="nav" px={4} position={"fixed"} zIndex={99} w={"100%"}>
...
<Box backgroundColor={"#003380"} w={"100%"}  position={"fixed"} zIndex={99} id="main_nav">
