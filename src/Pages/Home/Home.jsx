...
import  {AppleWatch, Card1, Card2, Headphones,Explore1, Laptops, Laptops2, Phones, Refrigerators, TV, BrandPromises}  from "./Data";
  ...
  return (
    <div >
     ...
     <Box  h="auto" mt={3} p={5} boxShadow=" rgba(0, 0, 0, 0.24) 0px 3px 8px">
       <BrandPromise type={BrandPromises} heading="THE RELIANCE DIGITAL BRAND PROMISE"/>
     </Box>
